...
const Navbar = () => {
  ...
  <img src ={logo} alt='' />
      ...
      <li><AnchorLink className='anchor-link'  offset={50} href='#services'> <p onClick={()=>setMenu("services")} >Mon expertise</p></AnchorLink> {menu === "services" ?<img src={underline} alt="" /> : <></>}</li>;
